...
@section('contain')
    <section
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-teal-50 to-cyan-50 px-4">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="{{ route('merchant.index') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl
