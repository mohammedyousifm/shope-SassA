...
@section('title', 'الاشتراك قيد المراجعة')
    ...
    <section class="min-h-[70vh] flex items-center justify-center mt-2">
        <div class="max-w-xl w-full bg-white rounded-2xl shadow-lg border p-8 text-center">
            ...
            <p class="text-gray-600 text-sm mb-6 leading-relaxed">
                تم استلام بيانات الدفع الخاصة بك بنجاح، ويجري حاليًا مراجعتها من قبل فريق الإدارة.
                <br>
                سيتم تفعيل الاشتراك فور التأكد من العملية.
            </p>
            ...
            <p class="text-sm text-gray-700 font-medium mb-4">
                الحالة الحالية: <span class="text-yellow-600 font-semibold">قيد المراجعة</span>
            </p>
            ...
            <p class="text-xs text-gray-400 mt-4">
                قد تستغرق المراجعة بعض الوقت، نشكرك على صبرك
            </p>
